...
<div class="container-fluid content">
    ...
    <div class="row {{Auth::user()->type == 'admin' ? 'justify-content-center': ''}}">
        <div class="col-lg-4">
            ...
            <div class="form-group">
                <p><i class="fas fa-user-cog"></i> Tip korisnika:
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <button class="btn btn-primary" data-toggle="modal" data-target="#exampleModal{{$buying->id}}"
                            title="Pogledaj narudžbu"><i class="fas fa-info-circle"></i>
                        </button>
